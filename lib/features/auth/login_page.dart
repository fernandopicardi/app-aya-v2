...
import 'package:app_aya_v2/config/routes.dart'; // For AppRouter.register
            ...
            child: SingleChildScrollView(
              ...
              child: Form( // Wrap with Form widget
                ...
                children: <Widget>[
                  ...
                  // Example: Icon(Icons.spa_outlined, size: 80, color: AppTheme.textPrimary.withOpacity(0.8)),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: Icon(Icons.lock_outlined, color: AppTheme.textPrimary.withAlpha(179)),
                    ),
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return 'Por favor, insira sua senha.';
                      }
                      if (value.length < 6) { // Example: password min length
                  ...
                  TextButton(
                    ...
                    child: Text('Esqueceu a senha?', style: TextStyle(color: AppTheme.buttonSecondary)),
                  ),
                  // ),
                ],
              ),
